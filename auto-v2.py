...
port = [8090,8091,8092,8098]

# port = [8086,8087,8089,8091,7003,7004,7010,8091,8092,81,82,83,84,85,90,9000,9001,9090
# 		,9091,9092,9093,91,92]
...
for i in all_filename:
	...
	time.sleep(5)
	move_command = 'mv '+end_file_port_json+' /home/zgrab/'
